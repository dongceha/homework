...
},{}],"src/homework.js":[function(require,module,exports) {
"use strict";
...
(function () {
  ...
  var title = (0, _snabbdom.h)('div', {
    id: 'app'
  }, [(0, _snabbdom.h)('h1', 'Top 10 movies'), (0, _snabbdom.h)('div', {}, [(0, _snabbdom.h)('span', 'sortBy'), (0, _snabbdom.h)('ul', {}, sortBy.map(function (sort) {
    return (0, _snabbdom.h)('li', {
      key: sort.name,
      on: {
...
function drawTable() {
  ...
  return function () {
    for (var i = 0; i < originalData.length; i++) {
      var prev = originalData[i - 1],
          now = originalData[i];
      now.offsetHeight = prev ? prev.offsetHeight + prev.elmHeight : 0;
    }

    var vnode = (0, _snabbdom.h)('table#app', {}, originalData.map(function (original) {
      return (0, _snabbdom.h)('tr.row', {
        style: {
          delayed: {
            transform: "translateY(".concat(original.offsetHeight, "px)")
          },
          remove: {
            opacity: '0',
            transform: "translateY(".concat(original.offsetHeight, "px) translateX(200px)")
          }
        },
        hook: {
          insert: function insert(vnode) {
            original.elmHeight = vnode.elm.offsetHeight;
          }
        },
        key: original.rank
      }, [(0, _snabbdom.h)('td', original.rank), (0, _snabbdom.h)('td', original.title), (0, _snabbdom.h)('td', original.desc), (0, _snabbdom.h)('td', [(0, _snabbdom.h)('button', {
        on: {
          click: function click() {
...
var drawSort = drawTable();
drawSort();

function handleSort(sort) {
  originalData = originalData.sort(function (ori1, ori2) {
...
function handleDelete(original) {
  var index = originalData.findIndex(function (or) {
    return original === or;
  });
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/homework.js"], null)
//# sourceMappingURL=/homework.47a9fc28.js.map